---
name: review-receipts-maintainer
description: Maintain deprecated Review Receipts's commands, documentation, examples, and release material as a public reference implementation. Use for changes in this repository.
---

# Maintain Review Receipts
...
Bind the expected selected file set, exact bytes and modes; reject replaced inputs and malformed receipts. A matching receipt neither authenticates its author nor approves a release.
